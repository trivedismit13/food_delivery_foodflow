...
public class InsightService {
    ...
    public InsightResponse generateCreatorInsight(Long creatorId, String question) {
        ...
        String prompt = """
            ...
            """.formatted(
                question,
                formatWeeklyTrend(context.get("weeklyTrend")),
                formatTopItems(context.get("topItems")),
                formatDropPerformance(context.get("dropPerformance")),
                context.get("bestDay"),
                context.get("repeatRate"),
                formatRecentDrops(context.get("recentDrops"))
            );
    ...
    private String formatWeeklyTrend(Object data) {
        return data != null ? data.toString() : "N/A";
    }

    private String formatTopItems(Object data) {
        return data != null ? data.toString() : "N/A";
    }

    private String formatDropPerformance(Object data) {
        return data != null ? data.toString() : "N/A";
    }

    private String formatRecentDrops(Object data) {
        return data != null ? data.toString() : "N/A";
    }
